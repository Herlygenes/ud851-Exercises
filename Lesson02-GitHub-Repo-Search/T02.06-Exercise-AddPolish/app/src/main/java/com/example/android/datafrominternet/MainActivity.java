...
public class MainActivity extends AppCompatActivity {
    ...
    public String getWeatherCondition(String jsonWeatherString){
        String condition = null;
        try {
            JSONObject weatherReport = new JSONObject(jsonWeatherString);
            JSONObject weather = weatherReport.getJSONObject("weather");
